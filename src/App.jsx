...
const LINKEDIN_URL = 'https://linkedin.com/in/AchmadAlfiansyah'
const GITHUB_URL = 'https://github.com/AlfiyansyaH'
      ...
      <div className="h-2 rounded-full bg-[var(--color-bg-tertiary)] overflow-hidden">
        <div
          className={`h-full rounded-full transition-all duration-700 ease-out ${
            hasError ? 'progress-bar-error' : 'progress-bar-gradient'
          }`}
...
function TerminalWindow({ logs, hasError }) {
  return (
    <div className={`w-full max-w-lg mx-auto rounded-xl overflow-hidden border ${
      hasError ? 'border-[var(--color-error-red)]/40 error-flash-bg' : 'border-[var(--color-border-subtle)]'
    }`}>
      {/* Title bar */}
